...
public class CommonBaseAction {
	...
	private ExecuteResult buildExecuteResult() {
		executeResult = (ExecuteResult) getSession().getAttribute(Constants.EXECUTE_RESULT_NAME);
	...
	public ExecuteResult getExecuteResult() {
		return (ExecuteResult) getSession().getAttribute(Constants.EXECUTE_RESULT_NAME);
	}
